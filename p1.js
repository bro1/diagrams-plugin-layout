...
Draw.loadPlugin(function(ui) {
	...
	if (ui.sidebar != null)
	{
	    ...
	    ui.sidebar.addPalette('esolia', 'eSolia', true, function(content) {
	        ...
	        content.appendChild(ui.sidebar.createVertexTemplate('shape=image;image=https://dev.w3.org/SVG/tools/svgweb/samples/svg-files/acid.svg;resizable=0;movable=0;rotatable=0', 100, 100));
